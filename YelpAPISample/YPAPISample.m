...
- (void)queryTopBusinessInfoForTerm:(NSDictionary *)params completionHandler:(void (^)(NSDictionary *topBusinessJSON, NSError *error))completionHandler {
    
    NSLog(@"Querying the Search API with term %@", params);
    
    //Make a first request to get the search results with the passed term and location
    NSURLRequest *searchRequest = [self _searchRequestWithParams:params];
...
/**
 ...
 @return The NSURLRequest needed to perform the search
 */
- (NSURLRequest *)_searchRequestWithParams:(NSDictionary *)params{
